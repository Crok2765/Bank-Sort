...
--	DEFAULT_CHAT_FRAME:AddMessage(ICON_LIST[8].."0\124t \124cffffff00Ordenado!\124r")
--UIErrorsFrame:AddMessage(ICON_LIST[8].."0\124t \124cffffff00Ordenado!!!!\124r")

if ShowSushiSortComplete then
...
function SOCD_MainFrame_OnEvent(self, event, ...)
	...
	elseif (event == "GUILDBANKFRAME_OPENED") then 
	    ...
	    if (guildSort == false) then
            Log("(guildSort == false)");
	        guildSort = true;
    	    CreateSortButton("GBankFrameSortButton", _G["GuildBankFrame"], 720, 10, SOCD_GuildSortButton);
